...
public class CodeGenerator {
    ...
    private static PackageConfig packageConfig() {
        ...
        packageInfo.setParent("edu.whu.homework6");
        //设置实体类包名
    ...
    private static GlobalConfig globalConfig() {
        ...
        //设置作者
        globalConfig.setAuthor("linsixing");
        //设置是否覆盖原始生成的文件
    ...
    private static DataSourceConfig dataSourceConfig() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/todo_db?useSSL=false&autoReconnect=true&characterEncoding=utf8&allowPublicKeyRetrieval=true");
        dataSource.setUsername("test1");
        dataSource.setPassword("test1@Localhost");
        return dataSource;
    }
}